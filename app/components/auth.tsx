    ...
    return (
        <div className="flex flex-col min-h-screen">
            <div className="flex flex-col flex-1 gap-8 items-center justify-center max-w-3xl mx-auto py-12 px-4 w-full">
                ...
                <p className="text-base-content/70 text-md"> See the <a target="_blank" href="/help" className="underline">help page</a> for more information on how to use the service.</p>
            </div>
            <Footer />
        </div>
    );
