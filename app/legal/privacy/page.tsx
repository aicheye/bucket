  ...
  return (
    <ProsePageContainer>
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          We only collect information necessary for account creation and course
        ...
        <p>
          ...
          number of active users and feature usage patterns.
        </p>
        <p>
        ...
        <p>
          Third-party services used for authentication (Google Cloud), data
          hosting (DigitalOcean), and frontend hosting (Netlify) do not have any
          additional access to your personal data beyond what is necessary to
          provide their services.
        </p>
        <h2 className="text-2xl font-bold">Data Security</h2>
        <p>
          We employ safeguards to protect your data, including encryption in
          transit (TLS) and at rest, regular security audits, and strict access
          controls.
        </p>
        ...
        <p>
          You can also enable anonymous mode in your account settings to remove
          personally identifiable information from our database. Once enabled,
          this mode ensures that your name, email, and profile picture are set
          to null, and your account is marked as anonymous. Additionally,
          telemetry consent will be disabled to enhance your privacy. Note that
          enabling anonymous mode will prevent you from receiving any and all
          email communications from us, including important updates and
          notifications.
        </p>
        <p>
        ...
        <p>
          We may update this Privacy Policy from time to time. User who have not
          turned on anonymous mode will be notified of any changes via email.
