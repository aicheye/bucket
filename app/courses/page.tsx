...
export default function CoursesPage() {
    ...
    if (courses.length > 0 && status === "authenticated") {
        return <div className="flex h-full items-center justify-center flex-col">
            <h2 className="text-2xl font-bold text-base-content/70">No course selected</h2>
            <p className="text-base-content/60">Select a course from the sidebar or add a new one.</p>
        </div>;
    }
