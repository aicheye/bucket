                      ...
                      {isEditingSections && (
                        <td>
                          <input
                            ...
                            checked={
                              selectedCourse?.sections?.[info.Component] ===
                              info.Section
                            }
                            onChange={() =>
                              selectedCourse &&
          ...
          <div className="card-body p-4 sm:p-8">
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                className={
                  "btn btn-sm btn-soft" +
                  (isEditingMarkingSchemes ? " btn-success" : "")
                }
                              ...
                              {isEditingMarkingSchemes ? (
                                <div className="flex items-center gap-2">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) =>
                                      updateComponentName(j, e.target.value)
                                    }
                                  />
                                </div>
                              ) : (
                              ...
                              {isEditingMarkingSchemes ? (
                                <div className="flex justify-end items-center gap-1">
                                  <input
                                    ...
                                    value={item.Weight}
                                    onChange={(e) =>
                                      updateWeight(i, j, e.target.value)
                                    }
                                  />
                                  <span className="w-4">
